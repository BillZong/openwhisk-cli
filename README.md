...
[![Build Status](https://travis-ci.org/BillZong/openwhisk-cli.svg?branch=master)](https://travis-ci.org/BillZong/openwhisk-cli)
...
The OpenWhisk CLI is available on the [releases page](https://github.com/BillZong/openwhisk-cli/releases). We
...
```
$ cd $GOPATH
$ go get github.com/BillZong/openwhisk-cli
$ cd $GOPATH/src/github.com/BillZong/openwhisk-cli
```
...
in the vendor folder. See this [issue](https://github.com/BillZong/openwhisk-cli/issues/398) for details.
```
